...
public class Video implements Serializable {
	private static final long serialVersionUID = 555105506134066108L;
	...
	public String toString() {
		return "Video [id=" + id + ", title=" + title + ", album=" + album
				+ ", artist=" + artist + ", displayName=" + displayName
				+ ", mimeType=" + mimeType + ", path=" + path + ", size="
				+ size + ", duration=" + duration + ", image=" + image + "]";
	}
}